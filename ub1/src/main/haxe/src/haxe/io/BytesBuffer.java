...
public class BytesBuffer extends haxe.lang.HxObject
{
	...
	public BytesBuffer()
	{
		//line 45 "/usr/local/lib/haxe/std/haxe/io/BytesBuffer.hx"
	...
	{
		//line 56 "/usr/local/lib/haxe/std/haxe/io/BytesBuffer.hx"
	...
	{
		//line 213 "/usr/local/lib/haxe/std/haxe/io/BytesBuffer.hx"
		byte[] buf = this.b.toByteArray();
		//line 214 "/usr/local/lib/haxe/std/haxe/io/BytesBuffer.hx"
		haxe.io.Bytes bytes = new haxe.io.Bytes(buf.length, buf);
		//line 222 "/usr/local/lib/haxe/std/haxe/io/BytesBuffer.hx"
		this.b = null;
		//line 223 "/usr/local/lib/haxe/std/haxe/io/BytesBuffer.hx"
		return bytes;
	}
	...
	{
		//line 25 "/usr/local/lib/haxe/std/haxe/io/BytesBuffer.hx"
		{
			//line 25 "/usr/local/lib/haxe/std/haxe/io/BytesBuffer.hx"
