...
public class Input extends haxe.lang.HxObject
{
	...
	public Input()
	{
		//line 32 "/usr/local/lib/haxe/std/haxe/io/Input.hx"
	...
	public int readByte()
	{
		//line 53 "/usr/local/lib/haxe/std/haxe/io/Input.hx"
	...
	public int readBytes(haxe.io.Bytes s, int pos, int len)
	{
		...
		try 
		{
			...
			byte[] b = s.b;
			//line 67 "/usr/local/lib/haxe/std/haxe/io/Input.hx"
			if (( ( ( pos < 0 ) || ( len < 0 ) ) || ( ( pos + len ) > s.length ) )) 
			{
				//line 68 "/usr/local/lib/haxe/std/haxe/io/Input.hx"
				throw ((java.lang.RuntimeException) (haxe.Exception.thrown(haxe.io.Error.OutsideBounds)) );
			}
			
			//line 70 "/usr/local/lib/haxe/std/haxe/io/Input.hx"
			try 
			{
				//line 70 "/usr/local/lib/haxe/std/haxe/io/Input.hx"
				while (( k > 0 ))
				{
					//line 78 "/usr/local/lib/haxe/std/haxe/io/Input.hx"
					b[pos] = ((byte) (this.readByte()) );
					//line 80 "/usr/local/lib/haxe/std/haxe/io/Input.hx"
					 ++ pos;
					//line 81 "/usr/local/lib/haxe/std/haxe/io/Input.hx"
					 -- k;
				}
			...
			{
				//line 69 "/usr/local/lib/haxe/std/haxe/io/Input.hx"
			...
			//line 84 "/usr/local/lib/haxe/std/haxe/io/Input.hx"
			return ( len - k );
		}
	...
	{
		//line 106 "/usr/local/lib/haxe/std/haxe/io/Input.hx"
		try 
		{
			//line 107 "/usr/local/lib/haxe/std/haxe/io/Input.hx"
			if (haxe.lang.Runtime.eq(bufsize, null)) 
			{
				//line 111 "/usr/local/lib/haxe/std/haxe/io/Input.hx"
				bufsize = 16384;
			}
			
			//line 114 "/usr/local/lib/haxe/std/haxe/io/Input.hx"
			haxe.io.Bytes buf = haxe.io.Bytes.alloc(((int) (haxe.lang.Runtime.toInt(bufsize)) ));
			//line 115 "/usr/local/lib/haxe/std/haxe/io/Input.hx"
			haxe.io.BytesBuffer total = new haxe.io.BytesBuffer();
			//line 117 "/usr/local/lib/haxe/std/haxe/io/Input.hx"
			try 
			{
				//line 117 "/usr/local/lib/haxe/std/haxe/io/Input.hx"
				while (true)
				{
					//line 118 "/usr/local/lib/haxe/std/haxe/io/Input.hx"
					int len = this.readBytes(buf, 0, ((int) (haxe.lang.Runtime.toInt(bufsize)) ));
					//line 119 "/usr/local/lib/haxe/std/haxe/io/Input.hx"
					if (( len == 0 )) 
					{
						//line 120 "/usr/local/lib/haxe/std/haxe/io/Input.hx"
						throw ((java.lang.RuntimeException) (haxe.Exception.thrown(haxe.io.Error.Blocked)) );
					}
					
					//line 121 "/usr/local/lib/haxe/std/haxe/io/Input.hx"
					{
						//line 121 "/usr/local/lib/haxe/std/haxe/io/Input.hx"
			...
			{
				//line 116 "/usr/local/lib/haxe/std/haxe/io/Input.hx"
				if ( ! (( ((java.lang.Object) (haxe.Exception.caught(_g).unwrap()) ) instanceof haxe.io.Eof )) ) 
				{
					//line 116 "/usr/local/lib/haxe/std/haxe/io/Input.hx"
					throw _g;
			...
			//line 124 "/usr/local/lib/haxe/std/haxe/io/Input.hx"
