...
public class Date extends haxe.lang.HxObject
{
	...
	{
		//line 35 "/usr/local/lib/haxe/std/java/_std/Date.hx"
		__hx_this.date = new java.util.GregorianCalendar(year, month, day, hour, min, sec);
		//line 36 "/usr/local/lib/haxe/std/java/_std/Date.hx"
		...
		//line 37 "/usr/local/lib/haxe/std/java/_std/Date.hx"
	...
	{
		//line 117 "/usr/local/lib/haxe/std/java/_std/Date.hx"
	...
	{
		//line 107 "/usr/local/lib/haxe/std/java/_std/Date.hx"
		...
		//line 109 "/usr/local/lib/haxe/std/java/_std/Date.hx"
		int h = this.date.get(((int) (java.util.Calendar.HOUR_OF_DAY) ));
		//line 110 "/usr/local/lib/haxe/std/java/_std/Date.hx"
