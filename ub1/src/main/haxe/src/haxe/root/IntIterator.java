...
public class IntIterator extends haxe.lang.HxObject
{
	...
	{
		//line 45 "/usr/local/lib/haxe/std/IntIterator.hx"
	...
	{
		//line 46 "/usr/local/lib/haxe/std/IntIterator.hx"
		__hx_this.min = min;
		//line 47 "/usr/local/lib/haxe/std/IntIterator.hx"
		__hx_this.max = max;
	}
	...
	{
		//line 54 "/usr/local/lib/haxe/std/IntIterator.hx"
	...
	{
		//line 63 "/usr/local/lib/haxe/std/IntIterator.hx"
		return this.min++;
	}
	...
	{
		//line 36 "/usr/local/lib/haxe/std/IntIterator.hx"
		{
			//line 36 "/usr/local/lib/haxe/std/IntIterator.hx"
