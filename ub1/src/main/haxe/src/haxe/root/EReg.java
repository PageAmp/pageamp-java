...
public class EReg extends haxe.lang.HxObject
{
	...
	{
		//line 34 "/usr/local/lib/haxe/std/java/_std/EReg.hx"
		int flags = 0;
		//line 35 "/usr/local/lib/haxe/std/java/_std/EReg.hx"
		{
			...
			while (( _g < _g1 ))
			{
				//line 35 "/usr/local/lib/haxe/std/java/_std/EReg.hx"
				int i = _g++;
				//line 36 "/usr/local/lib/haxe/std/java/_std/EReg.hx"
		...
		//line 50 "/usr/local/lib/haxe/std/java/_std/EReg.hx"
		flags |= java.util.regex.Pattern.UNICODE_CHARACTER_CLASS;
		//line 52 "/usr/local/lib/haxe/std/java/_std/EReg.hx"
		...
		//line 53 "/usr/local/lib/haxe/std/java/_std/EReg.hx"
		__hx_this.pattern = r;
	}
	...
	{
		//line 85 "/usr/local/lib/haxe/std/java/_std/EReg.hx"
		this.cur = s;
		//line 86 "/usr/local/lib/haxe/std/java/_std/EReg.hx"
		this.matcher = this.matcher.reset(((java.lang.CharSequence) (s) ));
		//line 87 "/usr/local/lib/haxe/std/java/_std/EReg.hx"
	...
	{
		//line 91 "/usr/local/lib/haxe/std/java/_std/EReg.hx"
		if (( n == 0 )) 
		{
			//line 92 "/usr/local/lib/haxe/std/java/_std/EReg.hx"
			return this.matcher.group();
		}
		else
		{
			//line 94 "/usr/local/lib/haxe/std/java/_std/EReg.hx"
	...
	{
		//line 98 "/usr/local/lib/haxe/std/java/_std/EReg.hx"
	...
	{
		//line 102 "/usr/local/lib/haxe/std/java/_std/EReg.hx"
	...
	{
		//line 106 "/usr/local/lib/haxe/std/java/_std/EReg.hx"
		int start = this.matcher.start();
		//line 107 "/usr/local/lib/haxe/std/java/_std/EReg.hx"
		{
			//line 107 "/usr/local/lib/haxe/std/java/_std/EReg.hx"
	...
	{
		//line 110 "/usr/local/lib/haxe/std/java/_std/EReg.hx"
		int len1 = ( (haxe.lang.Runtime.eq(len, null)) ? (-1) : (((int) (haxe.lang.Runtime.toInt(len)) )) );
		//line 111 "/usr/local/lib/haxe/std/java/_std/EReg.hx"
		this.matcher = this.matcher.reset(((java.lang.CharSequence) (( (( len1 < 0 )) ? (s) : (haxe.lang.StringExt.substr(s, 0, ( pos + len1 ))) )) ));
		//line 112 "/usr/local/lib/haxe/std/java/_std/EReg.hx"
		this.cur = s;
		//line 113 "/usr/local/lib/haxe/std/java/_std/EReg.hx"
	...
	{
		//line 117 "/usr/local/lib/haxe/std/java/_std/EReg.hx"
		if (this.isGlobal) 
		{
			//line 118 "/usr/local/lib/haxe/std/java/_std/EReg.hx"
			haxe.root.Array<java.lang.String> ret = new haxe.root.Array<java.lang.String>(new java.lang.String[]{});
			//line 119 "/usr/local/lib/haxe/std/java/_std/EReg.hx"
			while (this.match(s))
			{
				//line 120 "/usr/local/lib/haxe/std/java/_std/EReg.hx"
				ret.push(this.matchedLeft());
				//line 121 "/usr/local/lib/haxe/std/java/_std/EReg.hx"
				s = this.matchedRight();
			}
			
			//line 123 "/usr/local/lib/haxe/std/java/_std/EReg.hx"
			ret.push(s);
			//line 124 "/usr/local/lib/haxe/std/java/_std/EReg.hx"
			return ret;
		}
		else
		{
			//line 126 "/usr/local/lib/haxe/std/java/_std/EReg.hx"
			java.util.regex.Matcher m = this.matcher;
			//line 127 "/usr/local/lib/haxe/std/java/_std/EReg.hx"
			m.reset(((java.lang.CharSequence) (s) ));
			//line 128 "/usr/local/lib/haxe/std/java/_std/EReg.hx"
			if (m.find()) 
			{
				//line 129 "/usr/local/lib/haxe/std/java/_std/EReg.hx"
			...
			{
				//line 131 "/usr/local/lib/haxe/std/java/_std/EReg.hx"
	...
	{
		//line 145 "/usr/local/lib/haxe/std/java/_std/EReg.hx"
		this.matcher.reset(((java.lang.CharSequence) (s) ));
		//line 146 "/usr/local/lib/haxe/std/java/_std/EReg.hx"
		by = haxe.root.StringTools.replace(haxe.root.StringTools.replace(by, "\\", "\\\\"), "$$", "\\$");
		//line 147 "/usr/local/lib/haxe/std/java/_std/EReg.hx"
		if (this.isGlobal) 
		{
			//line 147 "/usr/local/lib/haxe/std/java/_std/EReg.hx"
	...
	{
		//line 151 "/usr/local/lib/haxe/std/java/_std/EReg.hx"
		int offset = 0;
		//line 152 "/usr/local/lib/haxe/std/java/_std/EReg.hx"
		haxe.root.StringBuf buf = new haxe.root.StringBuf();
		//line 153 "/usr/local/lib/haxe/std/java/_std/EReg.hx"
		while (true)
		{
			//line 154 "/usr/local/lib/haxe/std/java/_std/EReg.hx"
			if (( offset >= s.length() )) 
			{
				//line 155 "/usr/local/lib/haxe/std/java/_std/EReg.hx"
				break;
			}
			else
			{
				//line 156 "/usr/local/lib/haxe/std/java/_std/EReg.hx"
				if ( ! (this.matchSub(s, offset, null)) ) 
				{
					//line 157 "/usr/local/lib/haxe/std/java/_std/EReg.hx"
					buf.add(haxe.lang.Runtime.toString(haxe.lang.StringExt.substr(s, offset, null)));
					//line 157 "/usr/local/lib/haxe/std/java/_std/EReg.hx"
					java.lang.Object __temp_expr1 = ((java.lang.Object) (null) );
					//line 158 "/usr/local/lib/haxe/std/java/_std/EReg.hx"
					break;
				}
				
			}
			
			//line 160 "/usr/local/lib/haxe/std/java/_std/EReg.hx"
			java.lang.Object p = this.matchedPos();
			//line 161 "/usr/local/lib/haxe/std/java/_std/EReg.hx"
			...
			if (( ((int) (haxe.lang.Runtime.getField_f(p, "len", true)) ) == 0 )) 
			{
				...
				//line 165 "/usr/local/lib/haxe/std/java/_std/EReg.hx"
				offset = ( ((int) (haxe.lang.Runtime.getField_f(p, "pos", true)) ) + 1 );
			}
			else
			{
				//line 167 "/usr/local/lib/haxe/std/java/_std/EReg.hx"
		...
		//line 169 "/usr/local/lib/haxe/std/java/_std/EReg.hx"
		if (( (  ! (this.isGlobal)  && ( offset > 0 ) ) && ( offset < s.length() ) )) 
		{
			//line 170 "/usr/local/lib/haxe/std/java/_std/EReg.hx"
			buf.add(haxe.lang.Runtime.toString(haxe.lang.StringExt.substr(s, offset, null)));
			//line 170 "/usr/local/lib/haxe/std/java/_std/EReg.hx"
			java.lang.Object __temp_expr5 = ((java.lang.Object) (null) );
		}
		
		//line 171 "/usr/local/lib/haxe/std/java/_std/EReg.hx"
		return buf.toString();
	}
	...
	{
		//line 27 "/usr/local/lib/haxe/std/java/_std/EReg.hx"
		{
			//line 27 "/usr/local/lib/haxe/std/java/_std/EReg.hx"
