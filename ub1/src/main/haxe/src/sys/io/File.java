...
public class File extends haxe.lang.HxObject
{
	...
	public File()
	{
		//line 26 "/usr/local/lib/haxe/std/java/_std/sys/io/File.hx"
	...
	{
		//line 28 "/usr/local/lib/haxe/std/java/_std/sys/io/File.hx"
		sys.io.FileInput f = sys.io.File.read(path, false);
		//line 29 "/usr/local/lib/haxe/std/java/_std/sys/io/File.hx"
		java.lang.String ret = f.readAll(null).toString();
		//line 30 "/usr/local/lib/haxe/std/java/_std/sys/io/File.hx"
		f.close();
		//line 31 "/usr/local/lib/haxe/std/java/_std/sys/io/File.hx"
		return ret;
	}
	...
	{
		//line 54 "/usr/local/lib/haxe/std/java/_std/sys/io/File.hx"
		boolean binary1 = ( (haxe.lang.Runtime.eq(binary, null)) ? (true) : (haxe.lang.Runtime.toBool(((java.lang.Boolean) (binary) ))) );
		//line 55 "/usr/local/lib/haxe/std/java/_std/sys/io/File.hx"
		try 
		{
			//line 55 "/usr/local/lib/haxe/std/java/_std/sys/io/File.hx"
		...
		catch (java.lang.Throwable _g)
		{
			...
			//line 58 "/usr/local/lib/haxe/std/java/_std/sys/io/File.hx"
