...
var pageamp_Client = function() { };
$hxClasses["pageamp.Client"] = pageamp_Client;
pageamp_Client.__name__ = true;
pageamp_Client.main = function() {
	var doc = pageamp_lib_DomTools.domDefaultDoc();
	var pageProps = window.pageampProps;
	pageamp_Client.load(doc,pageProps);
};
pageamp_Client.load = function(doc,pageProps) {
	var _g = 0;
	...
	pageProps[0].id = 0;
	pageProps[0].dom = pageamp_lib_DomTools.domGetRootElement(doc);
	var ret = new pageamp_core_Page(doc,pageProps[0],pageProps);
	new pageamp_reactivity_ReConst(ret,"window",window);
	pageamp_Client.loadChildren(pageProps,ret,ret.dom);
	ret.context.refresh();
	return ret;
};
pageamp_Client.loadChildren = function(pageProps,p,dom) {
	var s;
	var clones = null;
	var child = pageamp_lib_DomTools.domFirstElementChild(dom);
	while(child != null) {
		s = pageamp_lib_DomTools.domGet(child,"data-id");
		if(s != null) {
			...
			props.dom = child;
			var e;
			switch(pageamp_lib_DomTools.domGetTagname(child)) {
			case "BODY":
				e = new pageamp_core_Body(p,props);
				break;
			case "HEAD":
				e = new pageamp_core_Head(p,props);
				break;
			default:
				e = new pageamp_core_Element(p,props);
			}
			pageamp_Client.loadChildren(pageProps,e,child);
			s = pageamp_lib_DomTools.domGet(child,"data-clone");
			if(s != null) {
				if(clones == null) {
					clones = [];
				}
			...
			pageamp_Client.loadChildren(pageProps,p,child);
		}
		child = pageamp_lib_DomTools.domNextElementSibling(child);
	}
};
var pageamp_lib_BaseNode = function(parent,plug,index,cb) {
...
$hxClasses["pageamp.lib.BaseNode"] = pageamp_lib_BaseNode;
pageamp_lib_BaseNode.__name__ = true;
pageamp_lib_BaseNode.prototype = {
	get_baseChildren: function() {
		if(this._cdn != null) {
			return this._cdn;
		} else {
			return pageamp_lib_BaseNode.NOCHILDREN;
		}
	}
	...
	,__class__: pageamp_lib_BaseNode
	,__properties__: {get_baseChildren:"get_baseChildren"}
};
var pageamp_reactivity_ReScope = function(parent,name,plug,index,cb) {
	...
	this.name = name;
	if(parent != null) {
		new pageamp_reactivity_ReConst(this,"parent",parent);
		if(name != null) {
			new pageamp_reactivity_ReConst(parent,name,this);
		}
		this.context = parent.context;
		new pageamp_reactivity_ReConst(this,"animate",$bind(this,this.animate));
		new pageamp_reactivity_ReConst(this,"delayedSet",$bind(this,this.delayedSet));
	} else {
		new pageamp_reactivity_ReConst(this,"root",this);
		if(name != null) {
			new pageamp_reactivity_ReConst(this,name,this);
		}
		this.context = new pageamp_reactivity_ReContext(this);
		new pageamp_reactivity_ReConst(this,"null",null);
		new pageamp_reactivity_ReConst(this,"true",true);
		new pageamp_reactivity_ReConst(this,"false",false);
		new pageamp_reactivity_ReConst(this,"trace",Reflect.makeVarArgs(function(el) {
		...
		new pageamp_reactivity_ReConst(this,"log",function(s) {
			console.log(s);
		});
		new pageamp_reactivity_ReConst(this,"__nn__",pageamp_lib_Util.orEmpty);
		new pageamp_reactivity_ReConst(this,"int",function(v) {
			return Std.parseInt(v + "");
		});
		new pageamp_reactivity_ReConst(this,"string",function(v) {
			return Std.string(v);
		});
		new pageamp_reactivity_ReConst(this,"trim",function(v) {
			if(v != null) {
				return StringTools.trim(Std.string(v));
			} else {
				return "";
			}
		});
		new pageamp_reactivity_ReConst(this,"upperCase",function(v) {
			if(v != null) {
		...
		new pageamp_reactivity_ReConst(this,"lowerCase",function(v) {
			if(v != null) {
		...
		new pageamp_reactivity_ReConst(this,"capitalize",function(s) {
			if(s == null) {
				s = "";
			}
			return new EReg("((^\\w)|(\\s+\\w))","g").map(s,function(re) {
				return re.matched(1).toUpperCase();
			});
		});
		new pageamp_reactivity_ReConst(this,"regex",function(v,opt) {
			if(opt == null) {
				opt = "";
			}
			if(v != null) {
				return new EReg(Std.string(v),opt);
			} else {
				return null;
			}
		});
		new pageamp_reactivity_ReConst(this,"Date",Date);
		new pageamp_reactivity_ReConst(this,"Math",Math);
	}
	new pageamp_reactivity_ReConst(this,"this",this);
	pageamp_lib_BaseNode.call(this,parent,plug,index,cb);
};
$hxClasses["pageamp.reactivity.ReScope"] = pageamp_reactivity_ReScope;
pageamp_reactivity_ReScope.__name__ = true;
pageamp_reactivity_ReScope.startAnimation = function(a) {
	var v1 = pageamp_reactivity_ReScope.toFloat(a.scope.get(a.key,false));
	var v2 = pageamp_reactivity_ReScope.toFloat(a.val);
	var suffix = pageamp_reactivity_ReScope.suffixRE.match(a.val + "") ? pageamp_reactivity_ReScope.suffixRE.matched(1) : null;
...
pageamp_reactivity_ReScope.toFloat = function(s,defval) {
	if(defval == null) {
		defval = 0;
	}
...
pageamp_reactivity_ReScope.toInt = function(s,defval) {
	if(defval == null) {
		defval = 0;
	}
...
pageamp_reactivity_ReScope.__super__ = pageamp_lib_BaseNode;
pageamp_reactivity_ReScope.prototype = $extend(pageamp_lib_BaseNode.prototype,{
	...
	,removeChild: function(child) {
		var childName = (js_Boot.__cast(child , pageamp_reactivity_ReScope)).name;
		if(childName != null) {
		...
		return pageamp_lib_BaseNode.prototype.removeChild.call(this,child);
	}
	,get: function(n,pull) {
		if(pull == null) {
			pull = true;
		}
		var value = this.resolve(n);
		if(value != null) {
	...
	,set: function(n,v,push) {
		...
		if(value != null) {
			...
			new pageamp_reactivity_ReValue(this,n,v);
		}
	}
	,trigger: function(n) {
		var value = this.resolve(n);
	...
	,exists: function(n) {
		if(pageamp_reactivity_ReInterp.ENABLE_UNKNOWN_VAR_EXCEPTION) {
	...
	,addValue: function(name,value,refreshable) {
		...
		value.k = name;
		this.ensureValues().h[name] = value;
		if(refreshable) {
	...
	,ensureRefreshableList: function() {
		if(this.refreshableList == null) {
			return this.refreshableList = new pageamp_lib_DoubleLinkedItem();
		} else {
	...
	,animate: function(key,val,secs,delay,cb,easingName) {
		...
		animation = { scope : scope, key : key, delay : function() {
			pageamp_reactivity_ReScope.startAnimation(animation);
	...
	,__class__: pageamp_reactivity_ReScope
	,__properties__: $extend(pageamp_lib_BaseNode.prototype.__properties__,{get_childScopes:"get_childScopes",get_parentScope:"get_parentScope",get_rootScope:"get_rootScope"})
});
var pageamp_core_Element = function(parent,props) {
	pageamp_reactivity_ReScope.call(this,parent,props.clone != null ? null : props.name);
	this.id = props.id != null ? props.id : this.baseRoot.registerElement(props);
	this.dom = props.dom;
	pageamp_lib_PropertyTools.set(props,"dom",null);
	this.clone = props.clone;
	pageamp_lib_PropertyTools.set(props,"clone",null);
	var _g = 0;
	...
	while(_g < _g1.length) {
		var k = _g1[_g];
		++_g;
		var value = new pageamp_reactivity_ReValue(this,"a_" + k,pageamp_lib_PropertyTools.get(props.attr,k));
		value.userData = k;
	...
	while(_g < _g1.length) {
		var k = _g1[_g];
		++_g;
		var v = pageamp_lib_PropertyTools.get(props.values,k);
		if(StringTools.startsWith(k,"event-")) {
			if(pageamp_reactivity_ReParser.isDynamic(v)) {
				this.addEventHandler(k,v);
			}
		} else if(StringTools.startsWith(k,"on-")) {
			if(pageamp_reactivity_ReParser.isDynamic(v)) {
				this.addValueHandler(k,v);
			}
		} else {
			var value = new pageamp_reactivity_ReValue(this,k,v);
			if(StringTools.startsWith(k,"class-")) {
				if(v == "") {
					value.v = true;
				}
				value.userData = pageamp_lib_Util.makeHyphenName(HxOverrides.substr(k,6,null));
				value.callback = $bind(this,this.classCallback);
			} else if(StringTools.startsWith(k,"style-")) {
				value.userData = pageamp_lib_Util.makeHyphenName(HxOverrides.substr(k,6,null));
	...
	if(props.texts != null) {
		...
		while(_g < _g1.length) {
			var t = _g1[_g];
			++_g;
			var value = new pageamp_reactivity_ReValue(this,"-tn" + t.index,t.text);
			value.userData = pageamp_lib_DomTools.domGetNthChild(this.dom,t.index);
			value.callback = $bind(this,this.textCallback);
		}
	}
	new pageamp_reactivity_ReConst(this,"dom",this.dom);
	pageamp_lib_DomTools.domSet(this.dom,"data-id","" + this.id);
	...
	if(props._v != null) {
		...
		while(_g < _g1.length) {
			...
			if(value != null) {
				value.v = pageamp_lib_PropertyTools.get(props._v,k);
			}
		}
	}
};
$hxClasses["pageamp.core.Element"] = pageamp_core_Element;
pageamp_core_Element.__name__ = true;
pageamp_core_Element.__super__ = pageamp_reactivity_ReScope;
pageamp_core_Element.prototype = $extend(pageamp_reactivity_ReScope.prototype,{
	get_root: function() {
		return this.baseRoot;
	}
	,get_parent: function() {
	...
	,addEventHandler: function(k,v) {
		var type = HxOverrides.substr(k,6,null);
		var value = new pageamp_reactivity_ReValue(this,k,null,v,false,false);
	...
	,addValueHandler: function(k,v) {
		...
		new pageamp_reactivity_ReValue(this,null,"[[" + name + "]]",v);
	}
	,attrCallback: function(v,k,attrName) {
		pageamp_lib_DomTools.domSet(this.dom,attrName,v);
		return v;
	}
	,textCallback: function(v,k,n) {
		pageamp_lib_DomTools.domSetNodeText(n,v);
		return v;
	}
	,classCallback: function(v,k,className) {
		if(typeof(v) == "string" && v != "false" || !(v == null || v == false || v == "false")) {
		...
		if(((v) instanceof Array)) {
			...
			if(this.clone != null) {
				...
				while(this.clones.length > count) {
					...
					pageamp_lib_DomTools.domRemove(c.dom);
	...
	,cloneSelf: function(cloneIndex) {
		var html = pageamp_lib_DomTools.domOuterHTML(this.dom);
		var wrapper = pageamp_lib_DomTools.domCreateElement(this.baseRoot.doc,"div");
		pageamp_lib_DomTools.domSetHtml(wrapper,html);
		var e = pageamp_lib_DomTools.domFirstElementChild(wrapper);
		pageamp_lib_DomTools.domSet(e,"data-clone","" + cloneIndex);
		pageamp_lib_DomTools.domAddChild(pageamp_lib_DomTools.domParent(this.dom),e,this.dom);
		var ret = this.baseRoot.load(this.baseParent,e,cloneIndex);
		return ret;
	}
	,__class__: pageamp_core_Element
	,__properties__: $extend(pageamp_reactivity_ReScope.prototype.__properties__,{get_parent:"get_parent",get_root:"get_root"})
});
var pageamp_core_Body = function(parent,props) {
	if(props == null) {
		props = { };
	}
	if(props.name == null) {
	...
	pageamp_core_Element.call(this,parent,props);
};
$hxClasses["pageamp.core.Body"] = pageamp_core_Body;
pageamp_core_Body.__name__ = true;
pageamp_core_Body.__super__ = pageamp_core_Element;
pageamp_core_Body.prototype = $extend(pageamp_core_Element.prototype,{
	__class__: pageamp_core_Body
});
var pageamp_core_Head = function(parent,props) {
	if(props == null) {
		props = { };
	}
	if(props.name == null) {
	...
	pageamp_core_Element.call(this,parent,props);
	new pageamp_reactivity_ReConst(this,"cssVendorize",function(s) {
		return "-moz-" + s + ";-webkit-" + s + ";-ms-" + s + ";" + s;
	});
	new pageamp_reactivity_ReConst(this,"cssVendorize2",function(prefix,s) {
		return "" + prefix + "-moz-" + s + ";" + prefix + "-webkit-" + s + ";" + prefix + "-ms-" + s + ";" + prefix + s;
	});
	new pageamp_reactivity_ReConst(this,"cssMakeSelectable",function() {
		return "-webkit-touch-callout:text;" + "-webkit-user-select:text;" + "-khtml-user-select:text;" + "-moz-user-select:text;" + "-ms-user-select:text;" + "user-select:text;";
	});
	new pageamp_reactivity_ReConst(this,"cssMakeNonSelectable",function() {
	...
	new pageamp_reactivity_ReConst(this,"cssFullRgb",pageamp_lib_ColorTools.fullRgb);
	new pageamp_reactivity_ReConst(this,"cssColor2Components",pageamp_lib_ColorTools.color2Components);
	new pageamp_reactivity_ReConst(this,"cssComponents2Color",pageamp_lib_ColorTools.components2Color);
	new pageamp_reactivity_ReConst(this,"cssColorOffset",pageamp_lib_ColorTools.colorOffset);
	new pageamp_reactivity_ReConst(this,"cssCounterColor",pageamp_lib_ColorTools.counterColor);
	new pageamp_reactivity_ReConst(this,"cssColorMix",pageamp_lib_ColorTools.mix);
};
$hxClasses["pageamp.core.Head"] = pageamp_core_Head;
pageamp_core_Head.__name__ = true;
pageamp_core_Head.__super__ = pageamp_core_Element;
pageamp_core_Head.prototype = $extend(pageamp_core_Element.prototype,{
	__class__: pageamp_core_Head
});
var pageamp_core_Page = function(doc,props,pageProps) {
	this.doc = doc;
	...
	pageamp_core_Element.call(this,null,props);
};
$hxClasses["pageamp.core.Page"] = pageamp_core_Page;
pageamp_core_Page.__name__ = true;
pageamp_core_Page.__super__ = pageamp_core_Element;
pageamp_core_Page.prototype = $extend(pageamp_core_Element.prototype,{
	...
	,getProps: function() {
		...
		while(_g < _g1.length) {
			...
			while(k.hasNext()) {
				var k1 = k.next();
				var v = e.values.h[k1];
				if(!StringTools.startsWith(k1,"-") && !((v) instanceof pageamp_reactivity_ReConst) && !v.isFunction) {
					if(p._v == null) {
						p._v = { };
					}
					pageamp_lib_PropertyTools.set2(p._v,k1,v.v);
				}
			}
			pageamp_lib_PropertyTools.set(p,"id",null);
			pageamp_lib_PropertyTools.set(p,"_e",null);
		}
		return this.propsRegistry;
	}
	,load: function(parent,dom,cloneIndex) {
		var _gthis = this;
		var id = Std.parseInt(pageamp_lib_DomTools.domGet(dom,"data-id"));
		var props = this.propsRegistry[id];
		props.dom = dom;
		if(cloneIndex != null) {
			props.clone = { source : id, index : cloneIndex};
		}
		var ret = new pageamp_core_Element(parent,props);
		var f = null;
		f = function(dom) {
			var e = pageamp_lib_DomTools.domFirstElementChild(dom);
			while(e != null) {
				if(pageamp_lib_DomTools.domGet(e,"data-id") != null) {
					_gthis.load(ret,e);
				}
				e = pageamp_lib_DomTools.domNextElementSibling(e);
			}
		};
		f(dom);
		return ret;
	}
	,__class__: pageamp_core_Page
});
var pageamp_lib_ArrayTools = function() { };
$hxClasses["pageamp.lib.ArrayTools"] = pageamp_lib_ArrayTools;
pageamp_lib_ArrayTools.__name__ = true;
pageamp_lib_ArrayTools.arrayPeek = function(a) {
	var len = a.length;
	if(len > 0) {
		return a[len - 1];
	} else {
...
pageamp_lib_ArrayTools.arrayLength = function(a) {
	if(a != null) {
		return a.length;
	} else {
		return 0;
...
pageamp_lib_ArrayTools.arraySort = function(array) {
...
var pageamp_lib_ColorTools = function() { };
$hxClasses["pageamp.lib.ColorTools"] = pageamp_lib_ColorTools;
pageamp_lib_ColorTools.__name__ = true;
pageamp_lib_ColorTools.fullRgb = function(s) {
	var ret = s;
	var re = new EReg("^#([0-9a-fA-F])([0-9a-fA-F])([0-9a-fA-F])$","");
	if(re.match(s)) {
		var r = re.matched(1);
		var g = re.matched(2);
		var b = re.matched(3);
...
pageamp_lib_ColorTools.color2IntComponents = function(s) {
	var ret = pageamp_lib_ColorTools.color2Components(s);
	ret.a = ret.a * 255 | 0;
	return ret;
};
pageamp_lib_ColorTools.color2Components = function(s) {
	var ret = null;
	var re1 = new EReg("#([0-9a-fA-F]{2})([0-9a-fA-F]{2})([0-9a-fA-F]{2})","");
	var re2 = new EReg("rgb\\s*[(]\\s*([0-9]+)\\s*,\\s*([0-9]+)\\s*,\\s*([0-9]+)\\s*[)]","");
	var re3 = new EReg("rgb\\s*[(]\\s*([0-9]+)[%]\\s*,\\s*([0-9]+)[%]\\s*,\\s*([0-9]+)[%]\\s*[)]","");
	var re4 = new EReg("rgba\\s*[(]\\s*([0-9]+)\\s*,\\s*([0-9]+)\\s*,\\s*([0-9]+)\\s*,\\s*([.0-9]+)\\s*[)]","");
	var re5 = new EReg("rgba\\s*[(]\\s*([0-9]+)[%]\\s*,\\s*([0-9]+)[%]\\s*,\\s*([0-9]+)[%]\\s*,\\s*([.0-9]+)\\s*[)]","");
	s = pageamp_lib_ColorTools.fullRgb(s);
	if(re1.match(s)) {
		ret = { r : Std.parseInt("0x" + re1.matched(1)), g : Std.parseInt("0x" + re1.matched(2)), b : Std.parseInt("0x" + re1.matched(3)), a : null};
	} else if(re2.match(s)) {
		ret = { r : Std.parseInt(re2.matched(1)), g : Std.parseInt(re2.matched(2)), b : Std.parseInt(re2.matched(3)), a : null};
	} else if(re3.match(s)) {
		ret = { r : Std.parseInt(re3.matched(1)) * 255 / 100 | 0, g : Std.parseInt(re3.matched(2)) * 255 / 100 | 0, b : Std.parseInt(re3.matched(3)) * 255 / 100 | 0, a : null};
	} else if(re4.match(s)) {
		ret = { r : Std.parseInt(re4.matched(1)), g : Std.parseInt(re4.matched(2)), b : Std.parseInt(re4.matched(3)), a : parseFloat(re4.matched(4))};
	} else if(re5.match(s)) {
		ret = { r : Std.parseInt(re5.matched(1)) * 255 / 100 | 0, g : Std.parseInt(re5.matched(2)) * 255 / 100 | 0, b : Std.parseInt(re5.matched(3)) * 255 / 100 | 0, a : parseFloat(re5.matched(4))};
	}
	return ret;
};
pageamp_lib_ColorTools.components2Color = function(rgba) {
	var ret = "#000";
	if(rgba != null) {
		if(rgba.a != null) {
			ret = "rgba(" + rgba.r + "," + rgba.g + "," + rgba.b + "," + rgba.a + ")";
		} else {
			ret = "#" + StringTools.hex(rgba.r,2) + StringTools.hex(rgba.g,2) + StringTools.hex(rgba.b,2);
		}
	}
	return ret;
};
pageamp_lib_ColorTools.components2hex = function(rgba) {
	return "#" + StringTools.hex(rgba.r,2) + StringTools.hex(rgba.g,2) + StringTools.hex(rgba.b,2);
};
pageamp_lib_ColorTools.colorOffset = function(col,offset,saturation,alpha) {
	if(saturation == null) {
		saturation = 1.0;
	}
	var o = Std.parseInt("" + Std.string(offset));
	var s = saturation;
	var rgba = pageamp_lib_ColorTools.color2Components(col);
	if(rgba != null) {
		var rr = rgba.r / 255.0;
		var rg = rgba.g / 255.0;
		var rb = rgba.b / 255.0;
		...
		rg -= v;
		rb -= v;
		rgba.r = Math.max(0,Math.min(255,(v + rr * s) * 255 + o)) | 0;
		rgba.g = Math.max(0,Math.min(255,(v + rg * s) * 255 + o)) | 0;
		rgba.b = Math.max(0,Math.min(255,(v + rb * s) * 255 + o)) | 0;
		rgba.a = alpha;
	}
	return pageamp_lib_ColorTools.components2Color(rgba);
};
pageamp_lib_ColorTools.counterColor = function(col,col1,col2,threshold) {
	if(threshold == null) {
		threshold = 176;
	}
	if(col2 == null) {
...
pageamp_lib_ColorTools.mix = function(col1,col2,ratio) {
	var rgba1 = pageamp_lib_ColorTools.color2Components(col1);
	var rgba2 = pageamp_lib_ColorTools.color2Components(col2);
	...
	var ret = pageamp_lib_ColorTools.components2Color({ r : Math.round((r2 * ratio + r1 * (1.0 - ratio)) * 255), g : Math.round((g2 * ratio + g1 * (1.0 - ratio)) * 255), b : Math.round((b2 * ratio + b1 * (1.0 - ratio)) * 255), a : null});
	return ret;
};
var pageamp_lib_DomTools = function() { };
$hxClasses["pageamp.lib.DomTools"] = pageamp_lib_DomTools;
pageamp_lib_DomTools.__name__ = true;
pageamp_lib_DomTools.domDefaultDoc = function() {
	return window.document;
};
pageamp_lib_DomTools.domGetRootElement = function(d) {
	return d.documentElement;
};
pageamp_lib_DomTools.domGetHead = function(doc) {
...
pageamp_lib_DomTools.domGetBody = function(doc) {
...
pageamp_lib_DomTools.domCreateElement = function(d,tagname) {
	return d.createElement(tagname);
};
pageamp_lib_DomTools.domCreateTextNode = function(d,text) {
	if(text == null) {
		text = "";
	}
	return d.createTextNode(text);
};
pageamp_lib_DomTools.domAddChild = function(e,n,before) {
	if(before != null) {
...
pageamp_lib_DomTools.domRemove = function(n) {
	if(n.parentElement != null) {
		n.parentElement.removeChild(n);
	}
};
pageamp_lib_DomTools.domParent = function(n) {
	return n.parentElement;
};
pageamp_lib_DomTools.domFirstChild = function(e) {
	return e.firstChild;
};
pageamp_lib_DomTools.domGetNthChild = function(e,i) {
...
pageamp_lib_DomTools.domFirstElementChild = function(e) {
	return e.firstElementChild;
};
pageamp_lib_DomTools.domNextSibling = function(e) {
	return e.nextSibling;
};
pageamp_lib_DomTools.domNextElementSibling = function(e) {
	return e.nextElementSibling;
};
pageamp_lib_DomTools.domAddEventHandler = function(e,type,h) {
	e.addEventListener(type,h);
};
pageamp_lib_DomTools.domRemoveEventHandler = function(e,type,h) {
	e.removeEventListener(type,h);
};
pageamp_lib_DomTools.domGetTagname = function(e) {
	return e.tagName;
};
pageamp_lib_DomTools.domSetNodeText = function(t,v) {
...
pageamp_lib_DomTools.domGetNodeText = function(t) {
	return t.nodeValue;
};
pageamp_lib_DomTools.domSetText = function(e,v) {
	v = v != null ? Std.string(v) : "";
	e.innerText = v;
};
pageamp_lib_DomTools.domSetHtml = function(e,v) {
	var tmp = v != null;
	e.innerHTML = v;
};
pageamp_lib_DomTools.domSet = function(e,k,v) {
	if(v != null) {
		e.setAttribute(k,v);
	} else {
		e.removeAttribute(k);
...
pageamp_lib_DomTools.domSet2 = function(e,k,v) {
	e.setAttribute(k,v);
};
pageamp_lib_DomTools.domGet = function(e,key) {
	return e.getAttribute(key);
};
pageamp_lib_DomTools.domCheck = function(e,key) {
	return e.hasAttribute(key);
};
pageamp_lib_DomTools.domAttributeNames = function(e) {
	return [];
};
pageamp_lib_DomTools.domOuterHTML = function(e) {
	return e.outerHTML;
};
var pageamp_lib_DoubleLinkedItem = function() {
};
$hxClasses["pageamp.lib.DoubleLinkedItem"] = pageamp_lib_DoubleLinkedItem;
pageamp_lib_DoubleLinkedItem.__name__ = true;
pageamp_lib_DoubleLinkedItem.prototype = {
	...
	,__class__: pageamp_lib_DoubleLinkedItem
};
var pageamp_lib_Observable = function(cb) {
	pageamp_lib_DoubleLinkedItem.call(this);
	this._cb = cb;
};
$hxClasses["pageamp.lib.Observable"] = pageamp_lib_Observable;
pageamp_lib_Observable.__name__ = true;
pageamp_lib_Observable.__super__ = pageamp_lib_DoubleLinkedItem;
pageamp_lib_Observable.prototype = $extend(pageamp_lib_DoubleLinkedItem.prototype,{
	...
	,__class__: pageamp_lib_Observable
});
var pageamp_lib_PropertyTools = function() { };
$hxClasses["pageamp.lib.PropertyTools"] = pageamp_lib_PropertyTools;
pageamp_lib_PropertyTools.__name__ = true;
pageamp_lib_PropertyTools.get = function(props,key,defval) {
...
pageamp_lib_PropertyTools.getString = function(props,key,defval) {
	return pageamp_lib_PropertyTools.get(props,key,defval);
};
pageamp_lib_PropertyTools.getInt = function(props,key,defval) {
	if(defval == null) {
		defval = 0;
	}
	var ret = Std.parseInt(pageamp_lib_PropertyTools.get(props,key));
	if(ret != null) {
		return ret;
	} else {
		return defval;
...
pageamp_lib_PropertyTools.set = function(props,key,val) {
	if(val != null) {
		if(props == null) {
			props = { };
		}
...
pageamp_lib_PropertyTools.set2 = function(props,key,val) {
	if(props == null) {
		props = { };
	}
	Reflect.setProperty(props,key,val);
...
pageamp_lib_PropertyTools.exists = function(props,key) {
	if(props != null) {
...
pageamp_lib_PropertyTools.remove = function(props,key) {
	if(props != null) {
		Reflect.deleteField(props,key);
	}
};
pageamp_lib_PropertyTools.keys = function(props) {
	if(props != null) {
...
pageamp_lib_PropertyTools.ensure = function(props,key,val) {
	if(!pageamp_lib_PropertyTools.exists(props,key)) {
		props = pageamp_lib_PropertyTools.set(props,key,val);
	}
	return props;
};
pageamp_lib_PropertyTools.ensure2 = function(props,key,val) {
	if(props == null) {
		props = { };
	}
	if(!pageamp_lib_PropertyTools.exists(props,key)) {
		pageamp_lib_PropertyTools.set2(props,key,val);
	}
	return props;
};
pageamp_lib_PropertyTools.ensureWith = function(props,$with) {
	var _g = 0;
	var _g1 = $with != null ? Reflect.fields($with) : [];
	while(_g < _g1.length) {
		var key = _g1[_g];
		++_g;
		props = pageamp_lib_PropertyTools.ensure(props,key,pageamp_lib_PropertyTools.get($with,key));
	}
	return props;
};
pageamp_lib_PropertyTools.clone = function(props) {
	var ret = null;
	if(props != null) {
		ret = { };
		var _g = 0;
		...
		while(_g < _g1.length) {
			var key = _g1[_g];
			++_g;
			pageamp_lib_PropertyTools.set(ret,key,pageamp_lib_PropertyTools.get(props,key));
		}
	}
	return ret;
};
pageamp_lib_PropertyTools.overwriteWith = function(props,$with) {
	...
	if($with != null) {
		...
		while(_g < _g1.length) {
			var key = _g1[_g];
			++_g;
			pageamp_lib_PropertyTools.set(ret,key,pageamp_lib_PropertyTools.get($with,key));
		}
	}
	return ret;
};
pageamp_lib_PropertyTools.fillWith = function(dst,src,overwrite) {
	if(overwrite == null) {
		overwrite = false;
	}
	...
	if(src != null) {
		...
		while(_g < _g1.length) {
			var key = _g1[_g];
			++_g;
			if(overwrite || !pageamp_lib_PropertyTools.exists(dst,key)) {
				pageamp_lib_PropertyTools.set(ret,key,pageamp_lib_PropertyTools.get(src,key));
			}
		}
	}
	return ret;
};
pageamp_lib_PropertyTools.overwrite = function(props,key,val,orRemove) {
	if(orRemove == null) {
		orRemove = false;
	}
	var ret = { existed : pageamp_lib_PropertyTools.exists(props,key), key : key, val : pageamp_lib_PropertyTools.get(props,key)};
	if(orRemove) {
		pageamp_lib_PropertyTools.remove(props,key);
	} else {
		pageamp_lib_PropertyTools.set(props,key,val);
	}
	return ret;
};
pageamp_lib_PropertyTools.restore = function(props,old) {
	if(old != null) {
		if(old.existed) {
			pageamp_lib_PropertyTools.set(props,old.key,old.val);
		} else {
			pageamp_lib_PropertyTools.remove(props,old.key);
		}
	}
};
var pageamp_lib_Set = {};
pageamp_lib_Set.add = function(this1,key) {
	this1.set(key,true);
};
pageamp_lib_Set.remove = function(this1,key) {
	return this1.remove(key);
};
pageamp_lib_Set.exists = function(this1,key) {
	return this1.exists(key);
};
pageamp_lib_Set.iterator = function(this1) {
	return this1.keys();
};
pageamp_lib_Set.toString = function(this1) {
	return this1.toString();
};
pageamp_lib_Set.toStringMap = function(t) {
	return new haxe_ds_StringMap();
};
pageamp_lib_Set.toIntMap = function(t) {
	return new haxe_ds_IntMap();
};
pageamp_lib_Set.toEnumValueMapMap = function(t) {
	return new haxe_ds_EnumValueMap();
};
pageamp_lib_Set.toObjectMap = function(t) {
	return new haxe_ds_ObjectMap();
};
var pageamp_lib_Util = function() { };
$hxClasses["pageamp.lib.Util"] = pageamp_lib_Util;
pageamp_lib_Util.__name__ = true;
pageamp_lib_Util.areEqual = function(a,b) {
	if(a != null) {
		return a == b;
	} else {
		return b == null;
...
pageamp_lib_Util.isTrue = function(v) {
...
pageamp_lib_Util.orEmpty = function(v) {
	if(v == null) {
		return "";
	} else {
		return Std.string(v);
...
pageamp_lib_Util.toInt = function(s) {
...
pageamp_lib_Util.toInt2 = function(s,defval) {
	var ret = Std.parseInt(s);
	if(ret != null) {
		return ret;
	} else {
...
pageamp_lib_Util.toFloat = function(s) {
...
pageamp_lib_Util.toFloat2 = function(s,defval) {
	var ret = parseFloat(s);
	if(ret != NaN) {
		return ret;
	} else {
...
pageamp_lib_Util.normalizeText = function(s) {
...
var pageamp_reactivity_ReValue = function(scope,k,v,handler,refreshable,handleFirst,parse) {
	if(parse == null) {
		parse = true;
	}
	if(handleFirst == null) {
	...
	if(handler != null) {
		this.handlerExpr = pageamp_reactivity_ReParser.parse(handler);
	}
	if(parse && typeof(v) == "string" && pageamp_reactivity_ReParser.isDynamic(v)) {
		this.expr = pageamp_reactivity_ReParser.parse(v);
		var _g = this.expr.e;
		if(_g._hx_index == 14) {
			var _g1 = _g.ret;
			var name = _g.name;
...
$hxClasses["pageamp.reactivity.ReValue"] = pageamp_reactivity_ReValue;
pageamp_reactivity_ReValue.__name__ = true;
pageamp_reactivity_ReValue.__super__ = pageamp_lib_DoubleLinkedItem;
pageamp_reactivity_ReValue.prototype = $extend(pageamp_lib_DoubleLinkedItem.prototype,{
	setState: function(v) {
		this.v = v;
	}
	,clearCycle: function() {
	...
	,get: function(pull) {
		...
		if(this.prev != null || this.first) {
			...
			if(pull && this.scope.context.isRefreshing) {
				var v = pageamp_lib_ArrayTools.arrayPeek(this.scope.context.stack);
				if(v != null) {
					this.addObserver($bind(v,v.observer));
				}
			}
		}
		return this.v;
	...
	,_set: function(v,force,push) {
		...
		if(this.__set(v,force) && !this.scope.context.isRefreshing) {
			var depth = this.scope.context.enterValuePush();
			if(depth == 1) {
	...
	,addObserver: function(o) {
		if(this.observable == null) {
			this.observable = new pageamp_lib_Observable();
		}
	...
	,__class__: pageamp_reactivity_ReValue
});
var pageamp_reactivity_ReConst = function(scope,k,v,handler,refreshable,handleFirst,parse) {
	if(parse == null) {
		parse = true;
	}
	if(handleFirst == null) {
	...
	pageamp_reactivity_ReValue.call(this,scope,k,v,handler,refreshable,handleFirst,parse);
	this.unlink();
};
$hxClasses["pageamp.reactivity.ReConst"] = pageamp_reactivity_ReConst;
pageamp_reactivity_ReConst.__name__ = true;
pageamp_reactivity_ReConst.__super__ = pageamp_reactivity_ReValue;
pageamp_reactivity_ReConst.prototype = $extend(pageamp_reactivity_ReValue.prototype,{
	set: function(v,push) {
		if(push == null) {
			push = false;
		}
	...
	,__class__: pageamp_reactivity_ReConst
});
var pageamp_reactivity_ReContext = function(root) {
	this.pushNesting = 0;
	this.root = root;
	this.cycle = 0;
	this.cycleTime = 0;
	this.isRefreshing = false;
	this.interp = new pageamp_reactivity_ReInterp();
	this.stack = [];
	this.observedList = new pageamp_lib_DoubleLinkedItem();
	this.applyList = new pageamp_lib_DoubleLinkedItem();
	this.pushNesting = 0;
};
$hxClasses["pageamp.reactivity.ReContext"] = pageamp_reactivity_ReContext;
pageamp_reactivity_ReContext.__name__ = true;
pageamp_reactivity_ReContext.prototype = {
	...
	,clearDependencies: function() {
		while(this.observedList.next != null) {
			(js_Boot.__cast(this.observedList.next , pageamp_lib_Observable)).clearObservers();
	...
	,callApplyList: function() {
		while(this.applyList.next != null) (js_Boot.__cast(this.applyList.next.unlink() , pageamp_reactivity_Applier)).cb();
	}
	,__class__: pageamp_reactivity_ReContext
};
var pageamp_reactivity_Applier = function(cb) {
	pageamp_lib_DoubleLinkedItem.call(this);
	this.cb = cb;
};
$hxClasses["pageamp.reactivity.Applier"] = pageamp_reactivity_Applier;
pageamp_reactivity_Applier.__name__ = true;
pageamp_reactivity_Applier.__super__ = pageamp_lib_DoubleLinkedItem;
pageamp_reactivity_Applier.prototype = $extend(pageamp_lib_DoubleLinkedItem.prototype,{
	apply: function() {
		this.cb();
	}
	,__class__: pageamp_reactivity_Applier
});
var pageamp_reactivity_ReInterp = function() {
	hscript_Interp.call(this);
};
$hxClasses["pageamp.reactivity.ReInterp"] = pageamp_reactivity_ReInterp;
pageamp_reactivity_ReInterp.__name__ = true;
pageamp_reactivity_ReInterp.__super__ = hscript_Interp;
pageamp_reactivity_ReInterp.prototype = $extend(hscript_Interp.prototype,{
	run: function(scope,expr) {
		var ret = null;
	...
	,get: function(o,f) {
		if(!pageamp_reactivity_ReInterp.ENABLE_UNKNOWN_VAR_EXCEPTION && o == null) {
			return null;
		}
		if(((o) instanceof pageamp_reactivity_ReScope)) {
			return o.get(f);
		} else {
	...
	,__class__: pageamp_reactivity_ReInterp
});
var pageamp_reactivity_ReParser = function() { };
$hxClasses["pageamp.reactivity.ReParser"] = pageamp_reactivity_ReParser;
pageamp_reactivity_ReParser.__name__ = true;
pageamp_reactivity_ReParser.isDynamic = function(s) {
	var i1 = s.indexOf("[[");
...
pageamp_reactivity_ReParser.parse = function(s,origin) {
	var ret = null;
	try {
		var code = pageamp_reactivity_ReParser.prepare(s);
		ret = pageamp_reactivity_ReParser.parser.parseString(code,origin);
	} catch( _g ) {
	}
	return ret;
};
pageamp_reactivity_ReParser.prepare = function(s) {
	var sb_b = "";
	var sep = "";
	var exprStart;
	var exprEnd;
...
pageamp_reactivity_ReParser.escape = function(s) {
	var _this_r = new RegExp("[']","g".split("u").join(""));
	var _this_r1 = new RegExp("[\"]","g".split("u").join(""));
...
pageamp_reactivity_ReParser.parser = new hscript_Parser();
pageamp_reactivity_ReParser.parser.allowJSON = true;
...
pageamp_lib_BaseNode.SELF_SLOT = "self";
pageamp_lib_BaseNode.DEFAULT_SLOT = "default";
pageamp_lib_BaseNode.CATCHALL_SLOT = "catchall";
pageamp_lib_BaseNode.NOCHILDREN = [];
pageamp_reactivity_ReScope.NOTNULL_FUNCTION = "__nn__";
pageamp_reactivity_ReScope.AUTOID_PREFIX = "-v";
pageamp_reactivity_ReScope.suffixRE = new EReg("([^\\d^-^\\.]+)\\s*$","");
pageamp_core_Element.DOMATTR_PREFIX = "a_";
pageamp_core_Element.CLASSATTR_PREFIX = "class-";
pageamp_core_Element.CLASSATTR_PREFIXLEN = 6;
pageamp_core_Element.STYLEATTR_PREFIX = "style-";
pageamp_core_Element.STYLEATTR_PREFIXLEN = 6;
pageamp_core_Element.EVENTATTR_PREFIX = "event-";
pageamp_core_Element.EVENTATTR_PREFIXLEN = 6;
pageamp_core_Element.HANDLERATTR_PREFIX = "on-";
pageamp_core_Element.HANDLERATTR_PREFIXLEN = 3;
pageamp_core_Element.ID_ATTR = "data-id";
pageamp_core_Element.CLONE_ATTR = "data-clone";
pageamp_core_Element.TEXT_PREFIX = "-tn";
pageamp_core_Element.DATA_VALUE = "data";
pageamp_core_Element.DATAOFFSET_VALUE = "dataOffset";
pageamp_core_Element.DATALENGTH_VALUE = "dataLength";
pageamp_reactivity_ReValue.MAX_DEPENDENCY_DEPTH = 100;
pageamp_reactivity_ReInterp.ENABLE_UNKNOWN_VAR_EXCEPTION = false;
pageamp_reactivity_ReParser.E1 = "[[";
pageamp_reactivity_ReParser.E2 = "]]";
pageamp_reactivity_ReParser.BLOCK_PREFIX = "__nn__" + "(";
pageamp_reactivity_ReParser.BLOCK_SUFFIX = ")";
pageamp_Client.main();
})(typeof window != "undefined" ? window : typeof global != "undefined" ? global : typeof self != "undefined" ? self : this);

//# sourceMappingURL=pageamp.js.map